...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName('bold')
            .setDescription('Post the bold opinion copypasta.'))
        .addSubcommand(subcommand =>
            subcommand.setName('chair')
            .setDescription('Post the crying clapping chair copypasta.'))
        .addSubcommand(subcommand =>
            subcommand.setName('bass_house')
	...
	async execute(interaction) {
        ...
        if (choice === 'bold') {
	    ...
	    } else if (choice == 'balls') {
            interaction.reply('We need to talk about your balls.\n' +
            'Are they smooth?\n' +
            'Or covered in bits of annoying fluff?\n' +
            'These are my balls!\n' +
            'See how they glisten in the light?\n' +
            'Your balls can be like these!\n' +
            'But you gotta use the right tool for the job.\n' +
            'This? No.\n' +
            'This? No!\n' +
            ...
            interaction.reply('This is for you, pea. You and only you. You are not special, you are not important, you have bad music taste, and you are not needed in HWRC.' +
